"""Integration tests for SQLAlchemy ORM (legacy style) generation."""
...
def test_sqlalchemy_basic_model_is_valid(load_generated_code) -> None:
    """Integration test: verify generated SQLAlchemy models are valid."""
    ddl = """
    CREATE TABLE users (
...
def test_sqlalchemy_model_columns(load_generated_code) -> None:
    """Integration test: verify columns are properly defined."""
    ddl = """
...
def test_sqlalchemy_foreign_key(load_generated_code) -> None:
...
def test_sqlalchemy_multiple_tables(load_generated_code) -> None:
    """Integration test: verify multiple tables generate correctly."""
    ddl = """
    CREATE TABLE users (
        id SERIAL PRIMARY KEY,
        name VARCHAR(100) NOT NULL
...
def test_sqlalchemy_relationships_with_back_populates(load_generated_code) -> None:
    ...
    # Verify relationships are defined as class attributes
    # The relationship should be in __mapper__.relationships
